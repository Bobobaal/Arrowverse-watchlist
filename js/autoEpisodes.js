...
const collapse5 = [new Episode("DC Legends Of Tomorrow", 3, 1, "Aruba-Con", true),
...
const collapse7 = [new Episode("Supergirl", 5, 1, "Event Horizon", true),
    ...
    new Episode("Arrow", 8, 8, "Crisis On Infinite Earths Part 4", true),
    new Episode("DC Legends Of Tomorrow", 5, 0, "Crisis On Infinite Earths Part 5", true),
    new Episode("Arrow", 8, 9, "What They Become", true),
    new Episode("Arrow", 8, 10, "Fadeout", true),
